...
class ProgressTaskBoardFormatRequestBuilder 
{
    ...
    */
     ...
     * @param \Microsoft\Graph\Generated\Models\PlannerProgressTaskBoardTaskFormat $body The request body
    ...
    */
    public function patch(\Microsoft\Graph\Generated\Models\PlannerProgressTaskBoardTaskFormat $body, ?ProgressTaskBoardFormatRequestBuilderPatchRequestConfiguration $requestConfiguration = null): ?Promise {
    ...
    */
     ...
     * @return RequestInformation
    */
    public function toPatchRequestInformation(\Microsoft\Graph\Generated\Models\PlannerProgressTaskBoardTaskFormat $body, ?ProgressTaskBoardFormatRequestBuilderPatchRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
