...
namespace Microsoft\Graph\Generated\Domains\Item\MicrosoftGraphForceDelete;
...
class MicrosoftGraphForceDeleteRequestBuilder 
{
    ...
    */
     ...
     * @param MicrosoftGraphForceDeleteRequestBuilderPostRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise
    ...
    */
    public function toPostRequestInformation(ForceDeletePostRequestBody $body, ?MicrosoftGraphForceDeleteRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
