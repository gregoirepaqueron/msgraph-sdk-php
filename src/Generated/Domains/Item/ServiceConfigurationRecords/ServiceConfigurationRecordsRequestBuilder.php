...
class ServiceConfigurationRecordsRequestBuilder 
{
    ...
    */
     ...
     * @param \Microsoft\Graph\Generated\Models\DomainDnsRecord $body The request body
     ...
     * @return Promise
    */
    public function post(\Microsoft\Graph\Generated\Models\DomainDnsRecord $body, ?ServiceConfigurationRecordsRequestBuilderPostRequestConfiguration $requestConfiguration = null): ?Promise {
    ...
    */
     ...
     * @return RequestInformation
    */
    public function toPostRequestInformation(\Microsoft\Graph\Generated\Models\DomainDnsRecord $body, ?ServiceConfigurationRecordsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
