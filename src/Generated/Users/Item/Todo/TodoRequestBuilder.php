...
class TodoRequestBuilder 
{
    ...
    */
     ...
     * @param \Microsoft\Graph\Generated\Models\Todo $body The request body
     ...
     * @return Promise
    */
    public function patch(\Microsoft\Graph\Generated\Models\Todo $body, ?TodoRequestBuilderPatchRequestConfiguration $requestConfiguration = null): ?Promise {
    ...
    */
     ...
     * @return RequestInformation
    */
    public function toPatchRequestInformation(\Microsoft\Graph\Generated\Models\Todo $body, ?TodoRequestBuilderPatchRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
