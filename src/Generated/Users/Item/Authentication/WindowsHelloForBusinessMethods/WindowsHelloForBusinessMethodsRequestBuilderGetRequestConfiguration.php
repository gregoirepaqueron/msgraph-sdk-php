...
class WindowsHelloForBusinessMethodsRequestBuilderGetRequestConfiguration 
{
    ...
    */
    ...
    /**
     * @var WindowsHelloForBusinessMethodsRequestBuilderGetQueryParameters $queryParameters Request query parameters
    */
    public WindowsHelloForBusinessMethodsRequestBuilderGetQueryParameters $queryParameters;
