...
class PasswordMethodsRequestBuilder 
{
    ...
    */
     ...
     * @param \Microsoft\Graph\Generated\Models\PasswordAuthenticationMethod $body The request body
     ...
     * @return Promise
    */
    public function post(\Microsoft\Graph\Generated\Models\PasswordAuthenticationMethod $body, ?PasswordMethodsRequestBuilderPostRequestConfiguration $requestConfiguration = null): ?Promise {
    ...
    */
     ...
     * @return RequestInformation
    */
    public function toPostRequestInformation(\Microsoft\Graph\Generated\Models\PasswordAuthenticationMethod $body, ?PasswordMethodsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
