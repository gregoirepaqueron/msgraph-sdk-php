...
class Fido2AuthenticationMethodItemRequestBuilderGetRequestConfiguration 
{
    ...
    */
    ...
    /**
     * @var Fido2AuthenticationMethodItemRequestBuilderGetQueryParameters $queryParameters Request query parameters
    */
    public Fido2AuthenticationMethodItemRequestBuilderGetQueryParameters $queryParameters;
