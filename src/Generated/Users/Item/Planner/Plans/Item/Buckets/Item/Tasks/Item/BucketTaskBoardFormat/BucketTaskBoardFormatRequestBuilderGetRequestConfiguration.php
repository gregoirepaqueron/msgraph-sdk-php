...
class BucketTaskBoardFormatRequestBuilderGetRequestConfiguration 
{
    ...
    */
    ...
    /**
     * @var BucketTaskBoardFormatRequestBuilderGetQueryParameters $queryParameters Request query parameters
    */
    public BucketTaskBoardFormatRequestBuilderGetQueryParameters $queryParameters;
