...
class ServiceUpdateMessageItemRequestBuilderGetRequestConfiguration 
{
    ...
    */
    ...
    /**
     * @var ServiceUpdateMessageItemRequestBuilderGetQueryParameters $queryParameters Request query parameters
    */
    public ServiceUpdateMessageItemRequestBuilderGetQueryParameters $queryParameters;
    ...
    */
    public static function addQueryParameters(?array $expand = null, ?array $select = null): ServiceUpdateMessageItemRequestBuilderGetQueryParameters {
