...
class DeletedItemsRequestBuilderGetRequestConfiguration 
{
    ...
    */
    ...
    /**
     * @var DeletedItemsRequestBuilderGetQueryParameters $queryParameters Request query parameters
    */
    public DeletedItemsRequestBuilderGetQueryParameters $queryParameters;
    ...
    */
    public static function addQueryParameters(?bool $count = null, ?array $expand = null, ?string $filter = null, ?array $orderby = null, ?string $search = null, ?array $select = null, ?int $skip = null, ?int $top = null): DeletedItemsRequestBuilderGetQueryParameters {
        return new DeletedItemsRequestBuilderGetQueryParameters($count, $expand, $filter, $orderby, $search, $select, $skip, $top);
    }
