...
class PrintRequestBuilderGetRequestConfiguration 
{
    ...
    */
    ...
    /**
     * @var PrintRequestBuilderGetQueryParameters $queryParameters Request query parameters
    */
    public PrintRequestBuilderGetQueryParameters $queryParameters;
    ...
    */
    public static function addQueryParameters(?array $expand = null, ?array $select = null): PrintRequestBuilderGetQueryParameters {
