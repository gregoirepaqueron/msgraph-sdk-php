...
class MicrosoftGraphUploadClientCertificateRequestBuilder 
{
    ...
    */
     ...
     * @param MicrosoftGraphUploadClientCertificateRequestBuilderPostRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise
    ...
    */
    public function post(UploadClientCertificatePostRequestBody $body, ?MicrosoftGraphUploadClientCertificateRequestBuilderPostRequestConfiguration $requestConfiguration = null): ?Promise {
    ...
    */
    public function toPostRequestInformation(UploadClientCertificatePostRequestBody $body, ?MicrosoftGraphUploadClientCertificateRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
