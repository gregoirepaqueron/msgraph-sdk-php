...
use Microsoft\Graph\Generated\Groups\Item\Onenote\Notebooks\MicrosoftGraphGetNotebookFromWebUrl\MicrosoftGraphGetNotebookFromWebUrlRequestBuilder;
use Microsoft\Graph\Generated\Groups\Item\Onenote\Notebooks\MicrosoftGraphGetRecentNotebooksWithIncludePersonalNotebooks\MicrosoftGraphGetRecentNotebooksWithIncludePersonalNotebooksRequestBuilder;
...
class NotebooksRequestBuilder 
{
    ...
    */
    public function post(\Microsoft\Graph\Generated\Models\Notebook $body, ?NotebooksRequestBuilderPostRequestConfiguration $requestConfiguration = null): ?Promise {
    ...
    */
     ...
     * @return RequestInformation
    */
    public function toPostRequestInformation(\Microsoft\Graph\Generated\Models\Notebook $body, ?NotebooksRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
