...
class ParentSectionRequestBuilderGetRequestConfiguration 
{
    ...
    */
    ...
    /**
     * @var ParentSectionRequestBuilderGetQueryParameters $queryParameters Request query parameters
    */
    public ParentSectionRequestBuilderGetQueryParameters $queryParameters;
