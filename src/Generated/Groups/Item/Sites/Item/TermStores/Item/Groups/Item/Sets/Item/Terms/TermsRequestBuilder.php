...
class TermsRequestBuilder 
{
    ...
    */
     ...
     * @return Promise
    */
    public function post(\Microsoft\Graph\Generated\Models\TermStore\Term $body, ?TermsRequestBuilderPostRequestConfiguration $requestConfiguration = null): ?Promise {
    ...
    */
     ...
     * @return RequestInformation
    */
    public function toPostRequestInformation(\Microsoft\Graph\Generated\Models\TermStore\Term $body, ?TermsRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
