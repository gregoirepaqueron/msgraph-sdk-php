...
class PermissionGrantsRequestBuilderGetRequestConfiguration 
{
    ...
    */
    ...
    /**
     * @var PermissionGrantsRequestBuilderGetQueryParameters $queryParameters Request query parameters
    */
    public PermissionGrantsRequestBuilderGetQueryParameters $queryParameters;
    ...
    */
    public static function addQueryParameters(?array $expand = null, ?string $filter = null, ?array $orderby = null, ?string $search = null, ?array $select = null): PermissionGrantsRequestBuilderGetQueryParameters {
