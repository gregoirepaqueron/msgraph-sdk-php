...
class PrintUsageByPrinterItemRequestBuilderGetRequestConfiguration 
{
    ...
    */
    ...
    /**
     * @var PrintUsageByPrinterItemRequestBuilderGetQueryParameters $queryParameters Request query parameters
    */
    public PrintUsageByPrinterItemRequestBuilderGetQueryParameters $queryParameters;
