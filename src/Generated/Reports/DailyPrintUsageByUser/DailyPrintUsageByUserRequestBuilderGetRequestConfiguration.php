...
class DailyPrintUsageByUserRequestBuilderGetRequestConfiguration 
{
    ...
    */
    ...
    /**
     * @var DailyPrintUsageByUserRequestBuilderGetQueryParameters $queryParameters Request query parameters
    */
    public DailyPrintUsageByUserRequestBuilderGetQueryParameters $queryParameters;
    ...
    */
    public static function addQueryParameters(?bool $count = null, ?array $expand = null, ?string $filter = null, ?array $orderby = null, ?string $search = null, ?array $select = null, ?int $skip = null, ?int $top = null): DailyPrintUsageByUserRequestBuilderGetQueryParameters {
