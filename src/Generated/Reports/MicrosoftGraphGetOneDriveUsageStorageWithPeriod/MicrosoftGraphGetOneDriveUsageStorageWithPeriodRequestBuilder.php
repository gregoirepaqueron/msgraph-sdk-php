...
class MicrosoftGraphGetOneDriveUsageStorageWithPeriodRequestBuilder 
{
    ...
    */
     ...
     * @param MicrosoftGraphGetOneDriveUsageStorageWithPeriodRequestBuilderGetRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise
    */
    public function get(?MicrosoftGraphGetOneDriveUsageStorageWithPeriodRequestBuilderGetRequestConfiguration $requestConfiguration = null): ?Promise {
    ...
    */
    public function toGetRequestInformation(?MicrosoftGraphGetOneDriveUsageStorageWithPeriodRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
