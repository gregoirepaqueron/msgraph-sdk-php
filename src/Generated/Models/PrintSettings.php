...
class PrintSettings implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getDocumentConversionEnabled(): ?bool {
        return $this->getBackingStore()->get('documentConversionEnabled');
    }
    ...
    */
    public function setDocumentConversionEnabled(?bool $value): void {
        $this->getBackingStore()->set('documentConversionEnabled', $value);
    }
