...
class DelegatedAdminAccessDetails implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getUnifiedRoles(): ?array {
        return $this->getBackingStore()->get('unifiedRoles');
    }
    ...
    */
    public function setUnifiedRoles(?array $value): void {
        $this->getBackingStore()->set('unifiedRoles', $value);
    }
