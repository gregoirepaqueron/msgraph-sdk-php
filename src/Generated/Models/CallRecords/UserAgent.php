...
class UserAgent implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getHeaderValue(): ?string {
        return $this->getBackingStore()->get('headerValue');
    }
    ...
    */
    public function setHeaderValue(?string $value): void {
        $this->getBackingStore()->set('headerValue', $value);
    }
