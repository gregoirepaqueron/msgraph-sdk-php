...
class RegistrationEnforcement implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getAuthenticationMethodsRegistrationCampaign(): ?AuthenticationMethodsRegistrationCampaign {
        return $this->getBackingStore()->get('authenticationMethodsRegistrationCampaign');
    }
    ...
    */
    public function setAuthenticationMethodsRegistrationCampaign(?AuthenticationMethodsRegistrationCampaign $value): void {
        $this->getBackingStore()->set('authenticationMethodsRegistrationCampaign', $value);
    }
