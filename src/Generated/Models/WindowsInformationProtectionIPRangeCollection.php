...
*/
class WindowsInformationProtectionIPRangeCollection implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'ranges' => fn(ParseNode $n) => $o->setRanges($n->getCollectionOfObjectValues([IpRange::class, 'createFromDiscriminatorValue'])),
        ];
    }
