...
class ExternalLink implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
     ...
     * @return ExternalLink
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ExternalLink {
