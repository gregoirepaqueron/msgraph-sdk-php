...
class PendingContentUpdate implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'queuedDateTime' => fn(ParseNode $n) => $o->setQueuedDateTime($n->getDateTimeValue()),
        ];
    }
    ...
    */
    public function getQueuedDateTime(): ?DateTime {
        return $this->getBackingStore()->get('queuedDateTime');
    }
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        ...
        $writer->writeDateTimeValue('queuedDateTime', $this->getQueuedDateTime());
    ...
    */
    public function setQueuedDateTime(?DateTime $value): void {
        $this->getBackingStore()->set('queuedDateTime', $value);
    }
