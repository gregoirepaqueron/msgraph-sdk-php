...
class SubmittedResourcesRequestBuilder 
{
    ...
    */
     ...
     * @return Promise
     * @link https://docs.microsoft.com/graph/api/educationsubmission-list-submittedresources?view=graph-rest-1.0 Find more info here
    */
     ...
     * @param \Microsoft\Graph\Generated\Models\EducationSubmissionResource $body The request body
     ...
     * @return Promise
    */
    public function post(\Microsoft\Graph\Generated\Models\EducationSubmissionResource $body, ?SubmittedResourcesRequestBuilderPostRequestConfiguration $requestConfiguration = null): ?Promise {
    ...
    */
     ...
     * @return RequestInformation
    */
    public function toPostRequestInformation(\Microsoft\Graph\Generated\Models\EducationSubmissionResource $body, ?SubmittedResourcesRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
