...
class FormatRequestBuilder 
{
    ...
    */
     ...
     * @param \Microsoft\Graph\Generated\Models\WorkbookChartAxisTitleFormat $body The request body
     ...
     * @return Promise
    */
    public function patch(\Microsoft\Graph\Generated\Models\WorkbookChartAxisTitleFormat $body, ?FormatRequestBuilderPatchRequestConfiguration $requestConfiguration = null): ?Promise {
    ...
    */
     ...
     * @return RequestInformation
    */
    public function toPatchRequestInformation(\Microsoft\Graph\Generated\Models\WorkbookChartAxisTitleFormat $body, ?FormatRequestBuilderPatchRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
