...
class MinorGridlinesRequestBuilderGetRequestConfiguration 
{
    ...
    */
    ...
    /**
     * @var MinorGridlinesRequestBuilderGetQueryParameters $queryParameters Request query parameters
    */
    public MinorGridlinesRequestBuilderGetQueryParameters $queryParameters;
