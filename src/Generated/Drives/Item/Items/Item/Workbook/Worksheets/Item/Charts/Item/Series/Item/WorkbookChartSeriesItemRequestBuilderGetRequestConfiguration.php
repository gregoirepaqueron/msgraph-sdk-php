...
class WorkbookChartSeriesItemRequestBuilderGetRequestConfiguration 
{
    ...
    */
    ...
    /**
     * @var WorkbookChartSeriesItemRequestBuilderGetQueryParameters $queryParameters Request query parameters
    */
    public WorkbookChartSeriesItemRequestBuilderGetQueryParameters $queryParameters;
