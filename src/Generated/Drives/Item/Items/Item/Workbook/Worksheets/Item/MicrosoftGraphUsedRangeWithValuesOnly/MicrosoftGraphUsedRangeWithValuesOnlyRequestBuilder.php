...
class MicrosoftGraphUsedRangeWithValuesOnlyRequestBuilder 
{
    ...
    */
     ...
     * @param MicrosoftGraphUsedRangeWithValuesOnlyRequestBuilderGetRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise
    */
    public function get(?MicrosoftGraphUsedRangeWithValuesOnlyRequestBuilderGetRequestConfiguration $requestConfiguration = null): ?Promise {
    ...
    */
    public function toGetRequestInformation(?MicrosoftGraphUsedRangeWithValuesOnlyRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
