...
class WorkbookChartItemRequestBuilder 
{
    ...
    */
     ...
     * @param \Microsoft\Graph\Generated\Models\WorkbookChart $body The request body
     ...
     * @return Promise
    */
    public function patch(\Microsoft\Graph\Generated\Models\WorkbookChart $body, ?WorkbookChartItemRequestBuilderPatchRequestConfiguration $requestConfiguration = null): ?Promise {
    ...
    */
     ...
     * @return RequestInformation
    */
    public function toPatchRequestInformation(\Microsoft\Graph\Generated\Models\WorkbookChart $body, ?WorkbookChartItemRequestBuilderPatchRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
