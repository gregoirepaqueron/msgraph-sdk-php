...
class MajorGridlinesRequestBuilderGetRequestConfiguration 
{
    ...
    */
    ...
    /**
     * @var MajorGridlinesRequestBuilderGetQueryParameters $queryParameters Request query parameters
    */
    public MajorGridlinesRequestBuilderGetQueryParameters $queryParameters;
