...
use Microsoft\Graph\Generated\Teams\Item\PrimaryChannel\Messages\Item\MicrosoftGraphSoftDelete\MicrosoftGraphSoftDeleteRequestBuilder;
use Microsoft\Graph\Generated\Teams\Item\PrimaryChannel\Messages\Item\MicrosoftGraphUndoSoftDelete\MicrosoftGraphUndoSoftDeleteRequestBuilder;
...
class ChatMessageItemRequestBuilder 
{
    ...
    */
     ...
     * Provides operations to manage the replies property of the microsoft.graph.chatMessage entity.
     * @param string $id Unique identifier of the item
     * @return \Microsoft\Graph\Generated\Teams\Item\PrimaryChannel\Messages\Item\Replies\Item\ChatMessageItemRequestBuilder
    */
    public function repliesById(string $id): \Microsoft\Graph\Generated\Teams\Item\PrimaryChannel\Messages\Item\Replies\Item\ChatMessageItemRequestBuilder {
        $urlTplParams = $this->pathParameters;
        $urlTplParams['chatMessage%2Did1'] = $id;
        return new \Microsoft\Graph\Generated\Teams\Item\PrimaryChannel\Messages\Item\Replies\Item\ChatMessageItemRequestBuilder($urlTplParams, $this->requestAdapter);
    }
