...
class TeamsRequestBuilderGetRequestConfiguration 
{
    ...
    */
    ...
    /**
     * @var TeamsRequestBuilderGetQueryParameters $queryParameters Request query parameters
    */
    public TeamsRequestBuilderGetQueryParameters $queryParameters;
    ...
    */
    public static function addQueryParameters(?bool $count = null, ?array $expand = null, ?string $filter = null, ?array $orderby = null, ?string $search = null, ?array $select = null, ?int $skip = null, ?int $top = null): TeamsRequestBuilderGetQueryParameters {
        return new TeamsRequestBuilderGetQueryParameters($count, $expand, $filter, $orderby, $search, $select, $skip, $top);
    }
