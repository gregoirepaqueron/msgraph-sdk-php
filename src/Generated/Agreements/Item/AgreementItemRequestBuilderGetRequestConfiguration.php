...
class AgreementItemRequestBuilderGetRequestConfiguration 
{
    ...
    */
    ...
    /**
     * @var AgreementItemRequestBuilderGetQueryParameters $queryParameters Request query parameters
    */
    public AgreementItemRequestBuilderGetQueryParameters $queryParameters;
    ...
    */
    public static function addQueryParameters(?array $select = null): AgreementItemRequestBuilderGetQueryParameters {
