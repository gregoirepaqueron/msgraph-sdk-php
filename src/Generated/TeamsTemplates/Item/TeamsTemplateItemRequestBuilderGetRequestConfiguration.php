...
class TeamsTemplateItemRequestBuilderGetRequestConfiguration 
{
    ...
    */
    ...
    /**
     * @var TeamsTemplateItemRequestBuilderGetQueryParameters $queryParameters Request query parameters
    */
    public TeamsTemplateItemRequestBuilderGetQueryParameters $queryParameters;
    ...
    */
    public static function addQueryParameters(?array $expand = null, ?array $select = null): TeamsTemplateItemRequestBuilderGetQueryParameters {
