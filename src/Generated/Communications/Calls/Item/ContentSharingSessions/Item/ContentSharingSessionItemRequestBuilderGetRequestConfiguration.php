...
class ContentSharingSessionItemRequestBuilderGetRequestConfiguration 
{
    ...
    */
    ...
    /**
     * @var ContentSharingSessionItemRequestBuilderGetQueryParameters $queryParameters Request query parameters
    */
    public ContentSharingSessionItemRequestBuilderGetQueryParameters $queryParameters;
    ...
    */
    public static function addQueryParameters(?array $expand = null, ?array $select = null): ContentSharingSessionItemRequestBuilderGetQueryParameters {
