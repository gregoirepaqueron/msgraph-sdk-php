...
class ManagedDeviceMobileAppConfigurationAssignmentItemRequestBuilder 
{
    ...
    */
     ...
     * @param \Microsoft\Graph\Generated\Models\ManagedDeviceMobileAppConfigurationAssignment $body The request body
     ...
     * @return Promise
    */
    public function patch(\Microsoft\Graph\Generated\Models\ManagedDeviceMobileAppConfigurationAssignment $body, ?ManagedDeviceMobileAppConfigurationAssignmentItemRequestBuilderPatchRequestConfiguration $requestConfiguration = null): ?Promise {
    ...
    */
     ...
     * @return RequestInformation
    */
    public function toPatchRequestInformation(\Microsoft\Graph\Generated\Models\ManagedDeviceMobileAppConfigurationAssignment $body, ?ManagedDeviceMobileAppConfigurationAssignmentItemRequestBuilderPatchRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
