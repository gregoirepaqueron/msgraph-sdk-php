...
class DefaultManagedAppProtectionItemRequestBuilderGetRequestConfiguration 
{
    ...
    */
    ...
    /**
     * @var DefaultManagedAppProtectionItemRequestBuilderGetQueryParameters $queryParameters Request query parameters
    */
    public DefaultManagedAppProtectionItemRequestBuilderGetQueryParameters $queryParameters;
