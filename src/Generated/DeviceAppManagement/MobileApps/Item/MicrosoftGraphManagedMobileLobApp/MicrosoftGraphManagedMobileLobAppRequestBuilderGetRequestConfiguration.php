...
class MicrosoftGraphManagedMobileLobAppRequestBuilderGetRequestConfiguration 
{
    ...
    */
    ...
    /**
     * @var MicrosoftGraphManagedMobileLobAppRequestBuilderGetQueryParameters $queryParameters Request query parameters
    */
    public MicrosoftGraphManagedMobileLobAppRequestBuilderGetQueryParameters $queryParameters;
