...
class GetDeviceManagementIntentPerSettingContributingProfilesPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): GetDeviceManagementIntentPerSettingContributingProfilesPostRequestBody {
