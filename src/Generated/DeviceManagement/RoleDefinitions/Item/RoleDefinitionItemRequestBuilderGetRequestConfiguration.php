...
class RoleDefinitionItemRequestBuilderGetRequestConfiguration 
{
    ...
    */
    ...
    /**
     * @var RoleDefinitionItemRequestBuilderGetQueryParameters $queryParameters Request query parameters
    */
    public RoleDefinitionItemRequestBuilderGetQueryParameters $queryParameters;
    ...
    */
    public static function addQueryParameters(?array $expand = null, ?array $select = null): RoleDefinitionItemRequestBuilderGetQueryParameters {
