...
class AuditEventsRequestBuilderGetRequestConfiguration 
{
    ...
    */
    ...
    /**
     * @var AuditEventsRequestBuilderGetQueryParameters $queryParameters Request query parameters
    */
    public AuditEventsRequestBuilderGetQueryParameters $queryParameters;
    ...
    */
    public static function addQueryParameters(?bool $count = null, ?array $expand = null, ?string $filter = null, ?array $orderby = null, ?string $search = null, ?array $select = null, ?int $skip = null, ?int $top = null): AuditEventsRequestBuilderGetQueryParameters {
