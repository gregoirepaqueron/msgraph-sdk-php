...
class DeviceStatusOverviewRequestBuilder 
{
    ...
    */
     ...
     * @param \Microsoft\Graph\Generated\Models\DeviceComplianceDeviceOverview $body The request body
     ...
     * @return Promise
    */
    public function patch(\Microsoft\Graph\Generated\Models\DeviceComplianceDeviceOverview $body, ?DeviceStatusOverviewRequestBuilderPatchRequestConfiguration $requestConfiguration = null): ?Promise {
    ...
    */
     ...
     * @return RequestInformation
    */
    public function toPatchRequestInformation(\Microsoft\Graph\Generated\Models\DeviceComplianceDeviceOverview $body, ?DeviceStatusOverviewRequestBuilderPatchRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
