...
class NotificationMessageTemplateItemRequestBuilderGetRequestConfiguration 
{
    ...
    */
    ...
    /**
     * @var NotificationMessageTemplateItemRequestBuilderGetQueryParameters $queryParameters Request query parameters
    */
    public NotificationMessageTemplateItemRequestBuilderGetQueryParameters $queryParameters;
