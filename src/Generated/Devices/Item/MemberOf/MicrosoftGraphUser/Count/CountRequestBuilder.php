...
namespace Microsoft\Graph\Generated\Devices\Item\MemberOf\MicrosoftGraphUser\Count;
...
class CountRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/devices/{device%2Did}/memberOf/microsoft.graph.user/$count{?%24search,%24filter}';
