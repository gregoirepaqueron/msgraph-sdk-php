...
namespace Microsoft\Graph\Generated\Devices\Item\TransitiveMemberOf\MicrosoftGraphUser\Count;
...
class CountRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/devices/{device%2Did}/transitiveMemberOf/microsoft.graph.user/$count{?%24search,%24filter}';
