...
class UserSourcesRequestBuilder 
{
    ...
    */
     ...
     * @return Promise
     * @link https://docs.microsoft.com/graph/api/security-ediscoverycustodian-list-usersources?view=graph-rest-1.0 Find more info here
    */
     ...
     * @param \Microsoft\Graph\Generated\Models\Security\UserSource $body The request body
    ...
    */
    public function post(\Microsoft\Graph\Generated\Models\Security\UserSource $body, ?UserSourcesRequestBuilderPostRequestConfiguration $requestConfiguration = null): ?Promise {
    ...
    */
     ...
     * @return RequestInformation
    */
    public function toPostRequestInformation(\Microsoft\Graph\Generated\Models\Security\UserSource $body, ?UserSourcesRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
