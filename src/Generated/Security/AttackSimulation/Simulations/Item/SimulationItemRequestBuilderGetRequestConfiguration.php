...
class SimulationItemRequestBuilderGetRequestConfiguration 
{
    ...
    */
    ...
    /**
     * @var SimulationItemRequestBuilderGetQueryParameters $queryParameters Request query parameters
    */
    public SimulationItemRequestBuilderGetQueryParameters $queryParameters;
    ...
    */
    public static function addQueryParameters(?array $expand = null, ?array $select = null): SimulationItemRequestBuilderGetQueryParameters {
