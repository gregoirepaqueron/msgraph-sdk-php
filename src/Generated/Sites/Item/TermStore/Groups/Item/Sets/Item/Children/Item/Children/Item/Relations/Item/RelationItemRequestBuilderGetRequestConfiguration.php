...
class RelationItemRequestBuilderGetRequestConfiguration 
{
    ...
    */
    ...
    /**
     * @var RelationItemRequestBuilderGetQueryParameters $queryParameters Request query parameters
    */
    public RelationItemRequestBuilderGetQueryParameters $queryParameters;
