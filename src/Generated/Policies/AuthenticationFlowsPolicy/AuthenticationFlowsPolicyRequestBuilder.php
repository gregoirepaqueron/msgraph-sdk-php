...
class AuthenticationFlowsPolicyRequestBuilder 
{
    ...
    */
     ...
     * @return Promise
     * @link https://docs.microsoft.com/graph/api/authenticationflowspolicy-get?view=graph-rest-1.0 Find more info here
    */
     ...
     * @param \Microsoft\Graph\Generated\Models\AuthenticationFlowsPolicy $body The request body
     ...
     * @return Promise
     * @link https://docs.microsoft.com/graph/api/authenticationflowspolicy-update?view=graph-rest-1.0 Find more info here
    */
    public function patch(\Microsoft\Graph\Generated\Models\AuthenticationFlowsPolicy $body, ?AuthenticationFlowsPolicyRequestBuilderPatchRequestConfiguration $requestConfiguration = null): ?Promise {
    ...
    */
     ...
     * @return RequestInformation
    */
    public function toPatchRequestInformation(\Microsoft\Graph\Generated\Models\AuthenticationFlowsPolicy $body, ?AuthenticationFlowsPolicyRequestBuilderPatchRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
