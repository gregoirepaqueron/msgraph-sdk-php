...
class PermissionGrantConditionSetItemRequestBuilderGetRequestConfiguration 
{
    ...
    */
    ...
    /**
     * @var PermissionGrantConditionSetItemRequestBuilderGetQueryParameters $queryParameters Request query parameters
    */
    public PermissionGrantConditionSetItemRequestBuilderGetQueryParameters $queryParameters;
