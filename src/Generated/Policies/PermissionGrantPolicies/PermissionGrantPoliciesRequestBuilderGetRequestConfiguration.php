...
class PermissionGrantPoliciesRequestBuilderGetRequestConfiguration 
{
    ...
    */
    ...
    /**
     * @var PermissionGrantPoliciesRequestBuilderGetQueryParameters $queryParameters Request query parameters
    */
    public PermissionGrantPoliciesRequestBuilderGetQueryParameters $queryParameters;
    ...
    */
    public static function addQueryParameters(?bool $count = null, ?array $expand = null, ?string $filter = null, ?array $orderby = null, ?string $search = null, ?array $select = null, ?int $skip = null, ?int $top = null): PermissionGrantPoliciesRequestBuilderGetQueryParameters {
