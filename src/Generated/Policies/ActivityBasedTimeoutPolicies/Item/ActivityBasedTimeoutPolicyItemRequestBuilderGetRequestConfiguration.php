...
class ActivityBasedTimeoutPolicyItemRequestBuilderGetRequestConfiguration 
{
    ...
    */
    ...
    /**
     * @var ActivityBasedTimeoutPolicyItemRequestBuilderGetQueryParameters $queryParameters Request query parameters
    */
    public ActivityBasedTimeoutPolicyItemRequestBuilderGetQueryParameters $queryParameters;
