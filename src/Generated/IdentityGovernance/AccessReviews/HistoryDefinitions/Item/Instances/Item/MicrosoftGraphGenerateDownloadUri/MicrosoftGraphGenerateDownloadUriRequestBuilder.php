...
namespace Microsoft\Graph\Generated\IdentityGovernance\AccessReviews\HistoryDefinitions\Item\Instances\Item\MicrosoftGraphGenerateDownloadUri;
...
class MicrosoftGraphGenerateDownloadUriRequestBuilder 
{
    ...
    */
     ...
     * @param MicrosoftGraphGenerateDownloadUriRequestBuilderPostRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise
    ...
    */
    public function post(?MicrosoftGraphGenerateDownloadUriRequestBuilderPostRequestConfiguration $requestConfiguration = null): ?Promise {
    ...
    */
    public function toPostRequestInformation(?MicrosoftGraphGenerateDownloadUriRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
