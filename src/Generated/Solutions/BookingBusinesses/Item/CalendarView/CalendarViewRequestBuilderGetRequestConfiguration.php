...
class CalendarViewRequestBuilderGetRequestConfiguration 
{
    ...
    */
    ...
    /**
     * @var CalendarViewRequestBuilderGetQueryParameters $queryParameters Request query parameters
    */
    public CalendarViewRequestBuilderGetQueryParameters $queryParameters;
    ...
    */
    public static function addQueryParameters(?bool $count = null, ?array $expand = null, ?string $filter = null, ?array $orderby = null, ?string $search = null, ?array $select = null, ?int $skip = null, ?int $top = null): CalendarViewRequestBuilderGetQueryParameters {
        return new CalendarViewRequestBuilderGetQueryParameters($count, $expand, $filter, $orderby, $search, $select, $skip, $top);
    }
