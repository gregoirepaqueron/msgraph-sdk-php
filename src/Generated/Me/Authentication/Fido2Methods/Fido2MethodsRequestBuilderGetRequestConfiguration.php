...
class Fido2MethodsRequestBuilderGetRequestConfiguration 
{
    ...
    */
    ...
    /**
     * @var Fido2MethodsRequestBuilderGetQueryParameters $queryParameters Request query parameters
    */
    public Fido2MethodsRequestBuilderGetQueryParameters $queryParameters;
    ...
    */
    public static function addQueryParameters(?bool $count = null, ?array $expand = null, ?string $filter = null, ?array $orderby = null, ?string $search = null, ?array $select = null, ?int $skip = null, ?int $top = null): Fido2MethodsRequestBuilderGetQueryParameters {
