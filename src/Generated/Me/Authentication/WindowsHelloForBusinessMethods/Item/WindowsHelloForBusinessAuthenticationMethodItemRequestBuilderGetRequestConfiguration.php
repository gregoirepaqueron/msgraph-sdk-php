...
class WindowsHelloForBusinessAuthenticationMethodItemRequestBuilderGetRequestConfiguration 
{
    ...
    */
    ...
    /**
     * @var WindowsHelloForBusinessAuthenticationMethodItemRequestBuilderGetQueryParameters $queryParameters Request query parameters
    */
    public WindowsHelloForBusinessAuthenticationMethodItemRequestBuilderGetQueryParameters $queryParameters;
