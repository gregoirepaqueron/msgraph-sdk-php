...
class AttachmentSessionsRequestBuilderGetRequestConfiguration 
{
    ...
    */
    ...
    /**
     * @var AttachmentSessionsRequestBuilderGetQueryParameters $queryParameters Request query parameters
    */
    public AttachmentSessionsRequestBuilderGetQueryParameters $queryParameters;
    ...
    */
    public static function addQueryParameters(?bool $count = null, ?string $filter = null, ?array $orderby = null, ?array $select = null, ?int $skip = null, ?int $top = null): AttachmentSessionsRequestBuilderGetQueryParameters {
