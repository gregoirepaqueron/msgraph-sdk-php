...
class MicrosoftGraphRoomRequestBuilderGetRequestConfiguration 
{
    ...
    */
    public static function addQueryParameters(?bool $count = null, ?array $expand = null, ?string $filter = null, ?array $orderby = null, ?string $search = null, ?array $select = null, ?int $skip = null, ?int $top = null): MicrosoftGraphRoomRequestBuilderGetQueryParameters {
        return new MicrosoftGraphRoomRequestBuilderGetQueryParameters($count, $expand, $filter, $orderby, $search, $select, $skip, $top);
    }
