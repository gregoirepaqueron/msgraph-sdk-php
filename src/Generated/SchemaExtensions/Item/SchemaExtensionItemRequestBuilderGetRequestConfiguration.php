...
class SchemaExtensionItemRequestBuilderGetRequestConfiguration 
{
    ...
    */
    ...
    /**
     * @var SchemaExtensionItemRequestBuilderGetQueryParameters $queryParameters Request query parameters
    */
    public SchemaExtensionItemRequestBuilderGetQueryParameters $queryParameters;
    ...
    */
    public static function addQueryParameters(?array $expand = null, ?array $select = null): SchemaExtensionItemRequestBuilderGetQueryParameters {
